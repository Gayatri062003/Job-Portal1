                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="PROVIDER_REG.php" class="dropdown-item">Provider</a>
                            <a href="SEEKER_REG.php" class="dropdown-item">Seeker</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="PROVIDER_LOGIN.php" class="dropdown-item">PROVIDER</a>
                            <a href="SEEKER_LOGIN.php" class="dropdown-item">SEEKER</a>
                        </div>
                    </div>
