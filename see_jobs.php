                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        ...
                                        <div class="text-start ps-4">
                                            <h5 class="mb-3"><?php echo $row["job_title"] ?></td></h5>
                                            <!-- <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i>New York, USA</span>
                                            <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i>Full Time</span>
                                            <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i>$123 - $456</span> -->
                                            <span class="text-truncate me-3"><i class="fa-map-marker-alt text-primary me-2"></i><?php echo $row["job_category"] ?></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            ...
                                            <a class="btn btn-primary" href="apply_jobs.php?id=<?php echo $row["job_id"]; ?>&seekerid=<?php echo $_SESSION['sid'] ?>">Apply Now</a>
